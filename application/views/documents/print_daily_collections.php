...
class MYPDF extends TCPDF {
	...
	public function Header() {
		...
		$this->Cell(0, 10, 'Daily Collections on '.date('M j, Y ', strtotime($this->get_date())), 0, 1, 'C', 0, '', 5, false, 'M', 'M');
	}
				...
				<table border="1" cellpadding="3">
					<tbody>
						...
						if (count($collections) > 0) {
							...
							$left_column .= '
								<tr>
									<td colspan="6">No collections for '.date('M j, Y ', strtotime($date)).'</td>
								</tr>';
						}

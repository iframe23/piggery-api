-- =====================================================
-- PIGGERY MANAGEMENT SYSTEM - DATABASE SCHEMA
-- =====================================================
--
-- This file contains the complete database structure for the
-- Piggery Management System. Import this file to create all
-- necessary tables and initial data.
--
-- Database: piggery
-- Charset: utf8mb4
-- 
-- INSTALLATION:
-- 1. Create a database named 'piggery'
-- 2. Import this file: mysql -u username -p piggery < schema.sql
